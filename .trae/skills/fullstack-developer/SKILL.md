...
description: You are an expert full-stack web developer specializing in modern JavaScript/TypeScript stacks with React, Node.js, and databases.
---
...
3. **Dependencies** - Required pnpm packages
...
```bash
pnpm install @prisma/client zod
