...
export class YahooFinanceClient implements YahooClient {
  ...
  async quote(
    ...
    return this.enqueue(
      async () =>
        (await this.client.quote(symbol, options)) as YahooQuote | YahooQuote[],
    );
  }
